    ...
    */
    ...
    'components' => [
        ...
        */
        ...
        |
        | Set to null so blade-icons does not claim <x-icon>. This app has its
        | own anonymous component at resources/views/components/icon.blade.php
        | backed by App\Support\Icons. Filament uses <x-filament::icon> and the
        | heroicon-* set, so nothing in vendor depends on this being 'icon'.
        |
        */
